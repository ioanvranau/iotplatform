...
@ComponentScan({"com.platform.iot.api.storage", "com.platform.iot.api.bussiness.model", "com.platform.iot.api", "com.platform.iot.api.producer"})
@PropertySource("classpath:jdbc.properties")
@EnableJpaRepositories("com.platform.iot.api.storage")
